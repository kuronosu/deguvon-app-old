...
public class MainApplication extends Application implements ReactApplication {
   ...
   * @param context
   */
  private static void initializeFlipper(Context context, final ReactInstanceManager reactInstanceManager) {
    if (BuildConfig.DEBUG) {
      try {
         ...
         */
        Class<?> aClass = Class.forName("com.deguvon.ReactNativeFlipper");
